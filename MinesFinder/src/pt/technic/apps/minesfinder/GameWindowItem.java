...
public class GameWindowItem extends GameWindow {      
    ...
    public GameWindowItem(Minefield minefield) {
    ...
    restartBtn.addMouseListener(new MouseAdapter() {
       	public void mouseClicked(MouseEvent e) {
       		try {
       			setVisible(false);
       			GameWindowItem gameWindow = new GameWindowItem(new Minefield(Minefield.getWidth(), Minefield.getHeight(), Minefield.getNumMines()));
